     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              <% String username=(String)session.getAttribute("username");
                                %>
                                <center><h2><font color="red">View Decrypt Key Request Status</font></h2></center>
...
<%
  ...
  ResultSet rs=st.executeQuery("select * from desreq  where username='"+username+"'");
  %>
                                <center>   <table border="2px">
                                    ...
                                    <%
                                        while(rs.next())
                                        {
                                            ...
                                            String deskey=rs.getString("deskey");
                                            %>
                                            <tr>
 ...
 <td><%=rs.getString("deskey")%></td>
 <td><a href="VerifyKey.jsp?fid=<%=rs.getString("fid")%>&id=<%=rs.getString("id")%>&filename=<%=rs.getString("filename")%>">View File</a></td>
