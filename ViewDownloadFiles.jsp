     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              <% String username=(String)session.getAttribute("username");
                                %>
                                <center><h2><font color="red">View All Downloaded Files</font></h2></center>
...
<%
  ...
  ResultSet rs=st.executeQuery("select * from transaction  where user='"+username+"' and task='Download'");
  %>
