    ...
    <section class="banner" id="top">
     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                            ...
                            if(did==null){
                                %>
                                <center><h2><font color="red">Decrypted Data</font></h2></center>
                                <center>
                                    <table>
                                        <tr><th>Decrypted Data</th></tr>
                                        <%try{
                                            
                                     ResultSet r=Queries.getExecuteQuery("select * from file where id='"+fid+"'");
                                     while(r.next()){
                                      
                                       %>
                                        <tr><td><textarea cols="70" rows="20"><%=r.getString("data")%></textarea></td></tr>  
                                        <%
...
out.println(e);
                                        ...
                                        <tr><td><a href="ViewDesFile.jsp?did=<%=fid%>&filename=<%=filename%>">Download</a></td></tr>
                                ...
                                <center>
                                    <h3>Verify Token</h3>
                                    <table>
                                        <tr><th></th><td><input type="text" name="filename" value="<%=filename%>"></td></tr>
                                         <tr><th></th><td><input type="text " name="fid" value="<%=did%>"></td></tr>
                                         <tr><th>Enter Token:</th><td><input type="text" name="token"></td><td><a href="getToken.jsp?fid=<%=did%>&filename=<%=filename%>">get Token</a></td></tr>
