            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="best-offer-left-content">
                        <div class="icon"><img src="img/arch.PNG" ></div>
                ...
                <div class="col-md-8">
                    <div class="best-offer-right-content">
                        <div class="row">
                            <div class="col-md-6 col-sm-12" style="width:auto;">
                                <%String username=(String)session.getAttribute("username");%>
                            
                            <h2><em>View File </em></h2>
                                <%
                                String id=request.getParameter("id");
                                if(id!=null){
                                   %>
                                       <a href="ViewFiles.jsp" style="margin-left:300px;">Back</a>   
                                   <table border="1"> 
                                       <tr>
                                           <th>File Data</th>
                                           <th>Cipher Data</th>
                                ...
                                %>
                                   <a href="OwnerHome.jsp" style="margin-left:300px;">Back</a>       
                                       ...
                                       while(r.next()){
                                        ...
                                        <tr>
                                           ...
                                           <td><%=r.getString("token")%></td>
                                            ...
                                            <td><a href="ViewFiles.jsp?id=<%=r.getString("id")%>" style="color:none;">View File Data</a></td>
                                        </tr>            
