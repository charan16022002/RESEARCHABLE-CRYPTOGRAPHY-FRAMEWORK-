     ...
     <section class="best-offer" id=best-offer-section>
        <div id="content">
                              <% String username=(String)session.getAttribute("username");
                                %>
                                <center><h2><font color="red">View Secured Files</font></h2></center>
                                ...
                                <center>   <table border="2px">
                                    ...
                                    <%
                                        while(rs.next())
                                        {
                                         ...
                                         ResultSet rr=Queries.getExecuteQuery("select * from file where filename!='"+filename+"'");
while(rr.next()){                                           
%>
                                            <tr>
                                                <td><%=rr.getString("id")%></td>
                                                <td><%=rr.getString("owner")%></td>
                                                
                                                <td><%=rr.getString("filename")%></td>
                                                <td><%=rr.getString("token")%></td>
